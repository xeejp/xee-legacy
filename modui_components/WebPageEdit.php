<?php
class WebPageEdit extends ModUIComponent{
    private $_con;
    ...
    public function get_templates($name){
        $template = <<<TMPL
<link rel="stylesheet" type="text/css" href="{$this->_url}js/CLEditor/jquery.cleditor.css" />
<h1>Webページ編集</h1>
<h5>
    注意:変数は0~9で始まらない半角英数文字で記述してください。</br>
        また、変数内で使える文字は1~9,a~z,A~Z,$,_(アンダーバー)です。</br>
        変数内での改行は禁止されています。
</h5>
...
<div id="under">
    ...
    <input class="pure-button" type="submit" id="{_name}" value="決定"></input>
...
<script type="text/javascript" src="{$this->_url}js/CLEditor/jquery.cleditor.min.js"></script>
SCRIPT
            .<<<'JS'
<style>
.popup{
